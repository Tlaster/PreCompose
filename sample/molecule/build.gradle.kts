...
compose {
    ...
    //                 }
    //                 val iosProperties = rootProject.file("ios.properties")
    //                 val hasIosProps = iosProperties.exists()
    //                 if (hasIosProps) {
    //                     val iosProp = loadProperties(iosProperties.absolutePath)
    //                     connectedDevice("Device") {
    //                         // First need specify your teamId here, or in local.properties (compose.ios.teamId=***)
    //                         teamId = iosProp.getProperty("TeamID")
